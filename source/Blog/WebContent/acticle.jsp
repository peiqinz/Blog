						...
						<div class="col-md-3" style="margin-top:100px">
							<div class="panel-3">
								...
								<div style="border: 1px dashed #DDDDDD;"></div>
			     		   	  	<img src="
			     		   	  				<s:if test="">
				     		   	  				<s:property value="#session.post.user.userPhoto"/>
				     		   	  			</s:if>
				     		   	  			<s:else>
				     		   	  				${pageContext.request.contextPath }/userPhoto/blog.png
				     		   	  			</s:else>" style="margin-top:20px;width:150px;height: 150px;text-align: center;margin-left: 30px;"></img>
			     		   	  				
			     		   	  	<p class="text-muted" style="margin-left: 85px;font-size: 15px;">
			     		   	  		<span><s:property value="#session.post.user.username"/></span>
			     		   	  	</p>
			     		   	  	...
			     		   	  	<div class="panel-body" style="padding-bottom: 0px;padding-top: 0px;">
			     		   	  		<s:iterator var="s" value="#session.hot">
				     		   	  		<p style="margin-top:15px;margin-bottom: -15px;width:100%;">
				     		   	  			...
				     		   	  			<span style="display: inline-block;height: 14px;float: right;">(<s:property value="#s.view"/>)</span>
				     		   	  		</p>
			     		   	  		</s:iterator>
			     		   	  	</div>
			     		    </div>
